...
в UTC-дату. Поле используется для прямой хронологической сортировки от первой опубликованной
заметки к более поздним, но на сайте отображается только дата. Необязательное поле `updated`
